...
"armv7l-linux-thread-multi-4.14.173-1-arch" or
	die "Errno architecture (armv7l-linux-thread-multi-4.14.173-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
