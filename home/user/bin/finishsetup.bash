...
printf "\n\e[1;34m:: \e[1;32m%s\n" "Processing system for Android armeabi-v7a 8.1.0 armeabi-v7a, and removing redundant packages for Termux PRoot installation if necessary..."
pacman -Syy || pacman -Syy || _PMFSESTRING_ "pacman -Syy finishsetup.bash ./setupTermuxArch.sh"
/root/bin/keys
pacman -Rc linux-armv7 linux-firmware --noconfirm --color=always || _PMFSESTRING_ "pacman -Rc linux-armv7 linux-firmware finishsetup.bash ./setupTermuxArch.sh"
pacman -Su patch sudo unzip --noconfirm --color=always || pacman -Su patch sudo unzip --noconfirm --color=always || _PMFSESTRING_ "pacman -Su patch sudo unzip finishsetup.bash ./setupTermuxArch.sh"
